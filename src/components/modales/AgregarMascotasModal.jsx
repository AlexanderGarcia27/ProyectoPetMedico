    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-lg p-8 w-[400px]">
                <h2 className="text-2xl font-semibold mb-4 text-cyan-700">Agregar Mascota</h2>
                <form>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" className="w-full p-2 border rounded" placeholder="Nombre del cliente" />
                    </div>
